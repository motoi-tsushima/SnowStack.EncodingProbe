...
- 状態: **1.1.0 の実装は完了済み（2026-08-31 時点）。本書は当時の作業指示の記録である**
- 実装後に判明した事実や、本書に無い判断の理由は
  `docs/EncodingProbe-1.1.0-作業引き継ぎメモ.md` にある
- **1 節「絶対に変更してはならないもの」の制約は、1.1.0 以降も引き続き有効である**
